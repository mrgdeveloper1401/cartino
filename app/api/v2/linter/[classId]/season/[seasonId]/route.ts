...
export async function GET(
  ...
  try {
    ...
    const prodReqUrl = `${V2_BASE_URL}/linter/class_purchase/${classId}/season/${seasonId}`;
    const devReqUrl = `http://localhost:8000/v2/linter/class_purchase/${classId}/season/${seasonId}`;
